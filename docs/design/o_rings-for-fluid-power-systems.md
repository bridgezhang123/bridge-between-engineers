...
- GB/T3452.1：尺寸系列及公差。目的是用于尺寸设计或验收。
    ...
    - 其中：d1内径/inside diameter = 8.75、d2线径/Diameter sections = 1.80；G为普通系列，A为航空级系列。
...
您好，关于GB/T 3452系列的应用，3452.5里，NBR材料的性能指标，硬度级别90 IRHD时，100℃-72h条件下，压缩永久变形(最大)为35%(gb/t 7759.1),此参数的意义是什么？https://www.bridgezhang.com/design/o_rings-for-fluid-power-systems/此网页提及压缩率的范围,压缩率太大，可能导致过大的永久变形;3452.3提及，如轴向密封时，3.55线径的最大允许压缩率为26%.  具体应用时，材质的最大允许压缩率是否应由材质自身特性决定，如果是，我在设计时，在此范围内即可，是这样吗？
