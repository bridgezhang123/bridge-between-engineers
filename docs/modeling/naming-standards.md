# Naming Standards / SolidWorks 建模 - 从零部件标准化的命名开始（包含文件夹命名）
...
### 3.3 Directory Structure / 推荐目录结构
...
### 3.4 Pre-release Checklist / 发布前核对清单
