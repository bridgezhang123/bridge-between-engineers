...
9. [软件版权](software-copyright.md)：在技术规范之外，补上一节关于工具来源与专业环境的讨论。

    SolidWorks 这类专业软件既是学习工具，也是工程工具。讨论软件版权，并不是为了轻视处在现实限制中的学习者或工程师，而是提醒我们：工程专业性不仅包括模型、图纸和版本管理，也包括对知识成果、授权边界和协作秩序的尊重。

    这篇补充文章关注的是如何在看见现实的同时不变得麻木，以及个人、团队和组织如何逐步向正版、合规、可协作的软件环境靠近。
