...
- 增加自定义 MkDocs 钩子，针对重命名文件场景重新计算创建日期，确保如 [关于作者](../about/author.md) 这类页面返回最早的真实创建时间。
...
- 重写 [关于站点](site.md) 与 [建站说明](site-building.md)，补充 Logo 图片、版权登记信息、外部链接提示和更清晰的建站说明结构。
...
- 新增 [协作说明](collaboration.md) 与 [版权与许可](copyright-license.md) 页面。
- 补充 Python、pip 与 MkDocs 环境问题的极简记录。
- 新增 `vercel.json` 与 `.python-version`，逐步理顺 Vercel 的构建与部署配置。

## 2026-03-27

- 拆分 [关于站点](site.md) 与 [建站说明](site-building.md)，将“站点介绍”与“建站复盘”分离。
...
- 重写 [关于站点](site.md) 页面，将原先偏流水记录的内容整理为更适合复盘与分享的结构化说明。
